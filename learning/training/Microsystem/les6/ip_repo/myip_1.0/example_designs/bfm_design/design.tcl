proc create_ipi_design { offsetfile design_name } {
	...
	set myip_0 [ create_bd_cell -type ip -vlnv Alok:user:myip:1.0 myip_0]
	...
	# Create interface connections
	connect_bd_intf_net [get_bd_intf_pins master_1/M_AXI] [get_bd_intf_pins myip_0/S01_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_1/M_AXI_ACLK] [get_bd_pins myip_0/S01_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_1/M_AXI_ARESETN] [get_bd_pins myip_0/S01_AXI_ARESETN]
	...
	set offset [get_property OFFSET [get_bd_addr_segs -of_objects [get_bd_addr_spaces master_1/Data]]]
	set offset_hex [string replace $offset 0 1 "32'h"]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores Alok:user:myip:1.0]]]]
