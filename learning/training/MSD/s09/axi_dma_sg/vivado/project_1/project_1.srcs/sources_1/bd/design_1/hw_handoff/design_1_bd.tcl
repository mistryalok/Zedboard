...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_include_mm2s {0} CONFIG.c_include_sg {0}  ] $axi_dma_0

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.C_GPIO_WIDTH {8}  ] $axi_gpio_0
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins sample_generator_0/FrameSize]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn] [get_bd_pins sample_generator_0/m_axis_aresetn] [get_bd_pins sample_generator_0/s_axis_aresetn]
