...
image_filter_Block_proc::image_filter_Block_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_sig_cseq_ST_st1_fsm_0 );
    sensitive << ( ap_sig_bdd_38 );
    sensitive << ( img_0_rows_V_fu_31_p1 );
    sensitive << ( ap_return_0_preg );

    SC_METHOD(thread_ap_return_1);
    sensitive << ( ap_sig_cseq_ST_st1_fsm_0 );
    sensitive << ( ap_sig_bdd_38 );
    sensitive << ( img_0_cols_V_fu_35_p1 );
    ...
    SC_METHOD(thread_img_0_cols_V_fu_35_p1);
    sensitive << ( cols );

    SC_METHOD(thread_img_0_rows_V_fu_31_p1);
    sensitive << ( rows );
    ...
    sc_trace(mVcdFile, img_0_rows_V_fu_31_p1, "img_0_rows_V_fu_31_p1");
    sc_trace(mVcdFile, img_0_cols_V_fu_35_p1, "img_0_cols_V_fu_35_p1");
...
void image_filter_Block_proc::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
             !ap_sig_bdd_38.read())) {
            ap_return_0_preg = img_0_rows_V_fu_31_p1.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
             !ap_sig_bdd_38.read())) {
            ap_return_1_preg = img_0_cols_V_fu_35_p1.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
             !ap_sig_bdd_38.read())) {
            ap_return_2_preg = img_0_rows_V_fu_31_p1.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
             !ap_sig_bdd_38.read())) {
            ap_return_3_preg = img_0_cols_V_fu_35_p1.read();
        }
    }
}
...
void image_filter_Block_proc::thread_ap_return_0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
         !ap_sig_bdd_38.read())) {
        ap_return_0 = img_0_rows_V_fu_31_p1.read();
    } else {
...
void image_filter_Block_proc::thread_ap_return_1() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
         !ap_sig_bdd_38.read())) {
        ap_return_1 = img_0_cols_V_fu_35_p1.read();
    } else {
...
void image_filter_Block_proc::thread_ap_return_2() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
         !ap_sig_bdd_38.read())) {
        ap_return_2 = img_0_rows_V_fu_31_p1.read();
    } else {
...
void image_filter_Block_proc::thread_ap_return_3() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
         !ap_sig_bdd_38.read())) {
        ap_return_3 = img_0_cols_V_fu_35_p1.read();
    } else {
...
void image_filter_Block_proc::thread_ap_sig_bdd_38() {
...
void image_filter_Block_proc::thread_img_0_cols_V_fu_35_p1() {
    img_0_cols_V_fu_35_p1 = cols.read().range(12-1, 0);
}

void image_filter_Block_proc::thread_img_0_rows_V_fu_31_p1() {
    img_0_rows_V_fu_31_p1 = rows.read().range(12-1, 0);
}
