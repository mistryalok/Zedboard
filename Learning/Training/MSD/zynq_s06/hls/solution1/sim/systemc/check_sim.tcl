...
proc check_tvin_file {} {
    set rtlfilelist {
         "c.axi_stream_counter_range.autotvin_count_range.dat"
         "c.axi_stream_counter_range.autotvin_counter.dat"
         "c.axi_stream_counter_range.autotvout_counter.dat"
         "c.axi_stream_counter_range.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    set rtlfilelist {
         "rtl.axi_stream_counter_range.autotvout_counter.dat"
         "rtl.axi_stream_counter_range.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
