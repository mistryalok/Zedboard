...
using namespace sc_dt;
   ...
   #define AUTOTB_TVOUT_PC_counter  "../tv/rtldatafile/rtl.axi_stream_counter_range.autotvout_counter.dat"
...
#define axi_stream_counter_range AESL_ORIG_DUT_axi_stream_counter_range
extern int axi_stream_counter_range ( int count_range,  int* counter);
...
int axi_stream_counter_range ( int count_range,  int* counter) {
    ...
    if (wrapc_switch_file_token.good()) {
        ...
        int AESL_return = AESL_ORIG_DUT_axi_stream_counter_range(count_range,counter);
