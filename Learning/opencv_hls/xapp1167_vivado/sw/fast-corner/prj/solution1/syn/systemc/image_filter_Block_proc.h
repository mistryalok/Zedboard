...
#ifndef _image_filter_Block_proc_HH_
#define _image_filter_Block_proc_HH_
...
struct image_filter_Block_proc : public sc_module {
    ...
    // Module declarations
    image_filter_Block_proc(sc_module_name name);
    SC_HAS_PROCESS(image_filter_Block_proc);

    ~image_filter_Block_proc();
    ...
    sc_signal< sc_lv<12> > p_src_rows_V_fu_31_p1;
    sc_signal< sc_lv<12> > p_src_cols_V_fu_35_p1;
    ...
    void thread_p_src_cols_V_fu_35_p1();
    void thread_p_src_rows_V_fu_31_p1();
