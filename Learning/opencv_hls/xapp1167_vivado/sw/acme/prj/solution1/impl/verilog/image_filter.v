...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.681000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=4,HLS_SYN_FF=1026,HLS_SYN_LUT=1358}" *)
...
begin : ap_ret_ap_reg_ready_img_0_rows_V_channel_full_n
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((image_filter_Block_proc_U0_ap_done == ap_const_logic_1) & (image_filter_Block_proc_U0_ap_continue == ap_const_logic_1))) begin
            ap_reg_ready_img_0_rows_V_channel_full_n <= ap_const_logic_0;
        end else if (((image_filter_Block_proc_U0_ap_done == ap_const_logic_1) & (img_0_rows_V_channel_full_n == ap_const_logic_1))) begin
...
always @ (ap_sig_ready_img_0_rows_V_channel_full_n or ap_sig_ready_img_1_rows_V_full_n or ap_sig_ready_img_1_cols_V_full_n or ap_sig_ready_img_0_cols_V_channel_full_n)
begin
    if (((ap_sig_ready_img_0_rows_V_channel_full_n == ap_const_logic_1) & (ap_const_logic_1 == ap_sig_ready_img_1_rows_V_full_n) & (ap_const_logic_1 == ap_sig_ready_img_1_cols_V_full_n) & (ap_const_logic_1 == ap_sig_ready_img_0_cols_V_channel_full_n))) begin
