...
set id 15
set name image_filter_mul_8ns_6ns_13_3
...
set id 18
set name image_filter_mul_10ns_12ns_22_2
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
set corename AM2S
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_am] == "::AESL_LIB_VIRTEX::xil_gen_am"} {
eval "::AESL_LIB_VIRTEX::xil_gen_am { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-101\] Cannot find ::AESL_LIB_VIRTEX::xil_gen_am, check your platform lib"
}
}
...
set ID 19
set MemName image_filter_Loop_1_proc_line_buffer_0_0_val
